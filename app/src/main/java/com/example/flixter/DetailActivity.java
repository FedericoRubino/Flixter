...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    public static final String apiKey = "AIzaSyCVRA_NWd267clVTovIUW8UBWe-q82VlOw";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle = findViewById(R.id.movieTitleDetail);
        tvOverview = findViewById(R.id.overViewDetails);
